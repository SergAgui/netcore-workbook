...
namespace BaseProject.End2EndTests
{
    public class TestChrome
    {
        ...
        public void CreatingNewIssueSavesCorrectly()
        {
            ...
            {
                driver.Navigate().GoToUrl(@"https://localhost:5000");
                var existing = driver.FindElementsByCssSelector("tbody a[href^='/Issue/Edit'");
                ...
                var submitButton = driver.FindElementByCssSelector("input.btn.btn-default");
                Assert.Contains("Create", submitButton.GetAttribute("value"));
                submitButton.Click();
